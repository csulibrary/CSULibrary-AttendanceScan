        ...
        <div class="w-[350px] flex flex-col justify-center gap-6">
          <div class="w-full bg-white/10 p-6 rounded-2xl border border-white/20 shadow-2xl">
            <div class="flex flex-col items-center gap-4">
              <label
                class="block text-center text-xs font-bold tracking-[0.2em] uppercase text-green-300 opacity-80"
              >
                Scan Student ID
              </label>
              <input
          ...
          >
            <table class="w-full text-white border-collapse">
              <thead class="bg-white/20 sticky top-0 z-20">
                <tr>
                  <th class="border border-white/10 p-4 font-bold text-lg uppercase tracking-wider">
                    ID Number
                  </th>
                  <th class="border border-white/10 p-4 font-bold text-lg uppercase tracking-wider">
                    Name
