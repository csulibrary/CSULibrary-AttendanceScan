    ...
    <div class="relative z-10 flex flex-col h-full w-full">
      <div class="flex items-center justify-center pt-8 pb-4 px-10 relative">
        ...
        <div class="text-center">
          ...
          >
            LIBRARY ATTENDANCE MONITORING (ACCESS)
          </div>
        </div>
      </div>
      ...
      <div class="flex-1 flex flex-row-reverse px-10 pb-10 gap-8 overflow-hidden">
        <div class="w-[400px] flex flex-col gap-4">
          <div
            class="bg-black/40 border border-white/10 p-6 rounded-2xl text-center backdrop-blur-md"
          >
          ...
          <div
            class="flex-1 bg-black/60 rounded-2xl border-2 border-green-600 overflow-hidden relative flex flex-col shadow-2xl"
          >
        ...
        <div class="flex-1 flex flex-col min-h-0">
          <div
            class="flex-1 bg-white/10 rounded-2xl overflow-auto border border-white/20 backdrop-blur-sm shadow-2xl"
          >
...
const fetchLogs = async () => {
  ...
  if (data) {
    attendanceLogs.value = data.map((log) => ({
      ...log,
      log_time: new Date(log.created_at).toLocaleTimeString([], {
        hour: '2-digit',
        minute: '2-digit',
        second: '2-digit',
      }),
