            ...
            <div class="px-3 pt-3 relative">
              ...
              <div class="absolute inset-3 flex items-center justify-center px-3 pointer-events-none">
                <input
                  ...
                  class="w-full h-full rounded-xl border-2 border-white/80 bg-black/60 p-6 text-4xl font-extrabold text-white placeholder:text-white/70 placeholder:text-4xl placeholder:font-extrabold focus:outline-none focus:ring-4 focus:ring-green-500 pointer-events-auto"
